...
export default function InvestmentHighlightsSection() {
  ...
  return (
    <section className="py-6 sm:py-10 md:py-20 px-3 sm:px-6 md:px-8 bg-gradient-to-r from-orange-600 to-orange-700 text-white">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-3 gap-2 sm:gap-6 md:gap-12 text-center">
          {highlights.map((highlight, index) => (
            ...
            >
              ...
              <p className="hidden sm:block text-orange-100 text-[10px] sm:text-lg">
                {highlight.label}
              </p>
            </div>
          ))}
