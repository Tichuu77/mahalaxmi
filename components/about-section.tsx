...
export default function AboutSection() {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white via-[#30534A]/5 to-white relative overflow-hidden">
      {/* Animated Background Elements */}
      <div className="absolute top-20 right-10 w-72 h-72 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ backgroundColor: '#30534A' }} />
      <div className="absolute bottom-20 left-10 w-72 h-72 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ backgroundColor: '#C9862B' }} />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            {/* Badge */}
            <div className="inline-flex items-center gap-2 mb-4 sm:mb-6 px-4 py-2 rounded-full" style={{ backgroundColor: '#30534A15' }}>
              <div className="w-2 h-2 rounded-full animate-pulse" style={{ backgroundColor: '#30534A' }} />
              <span className="font-bold text-xs sm:text-sm uppercase tracking-wider" style={{ color: '#30534A' }}>About Us</span>
            </div>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 mb-4 sm:mb-6 leading-tight">
              ...
              <span className="relative inline-block" style={{ color: '#30534A' }}>
                Reality
                <svg className="absolute -bottom-2 left-0 w-full" height="8" viewBox="0 0 100 8" fill="none">
                  <path d="M0 4C20 2 40 6 60 4C80 2 90 6 100 4" stroke="#C9862B" strokeWidth="2" fill="none" />
                </svg>
              </span>
            </h2>
            ...
            <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
              {features.map((feature, idx) => {
                ...
                return (
                  ...
                  >
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors" style={{ backgroundColor: '#30534A15' }}>
                      <Icon className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: '#30534A' }} />
                    </div>
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
              <div className="p-4 sm:p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105" style={{ background: 'linear-gradient(135deg, #30534A, #3d6b60)' }}>
                <div className="text-2xl sm:text-3xl md:text-4xl font-black text-white">
                  {countUp.customers.toLocaleString()}+
                </div>
                <div className="text-xs sm:text-sm mt-1 sm:mt-2 font-semibold" style={{ color: '#C9862B' }}>Satisfied Customers</div>
              </div>
              <div className="p-4 sm:p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105" style={{ background: 'linear-gradient(135deg, #3d6b60, #30534A)' }}>
                <div className="text-2xl sm:text-3xl md:text-4xl font-black text-white">{countUp.happiness}%</div>
                <div className="text-xs sm:text-sm mt-1 sm:mt-2 font-semibold" style={{ color: '#C9862B' }}>Happy Families</div>
              </div>
            </div>

            {/* CTA Button */}
            <Button
              className="text-white gap-2 px-6 sm:px-8 py-5 sm:py-6 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 text-sm sm:text-base font-bold w-full sm:w-auto"
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 relative">
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#30534A]/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                </div>
              </div>
              ...
              >
                <div className="px-4 sm:px-6 py-2 sm:py-3 text-white rounded-full shadow-2xl flex items-center gap-2 animate-bounce" style={{ background: 'linear-gradient(135deg, #30534A, #3d6b60)' }}>
