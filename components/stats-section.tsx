...
export default function StatsSection() {
  ...
  return (
    <section id="stats" ref={sectionRef} className="py-6 sm:py-16 md:py-20 px-3 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-white" style={{ backgroundImage: 'linear-gradient(to bottom, #30534A0D, #ffffff)' }}>
          ...
          {stats.map((stat, idx) => {
            ...
            return (
              <div
                ...
                style={{ transitionDelay: `${idx * 100}ms`, borderColor: '#30534A20', borderWidth: 1, borderStyle: 'solid' }}
              >
                {/* Icon Background - Very compact on mobile */}
                <div
                  className="w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 rounded-md sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 group-hover:rotate-12 transition-transform duration-300"
